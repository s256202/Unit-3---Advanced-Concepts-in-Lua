...
local function DetermineAlternateAnswers()    
    ...
    -- generate incorrect answer and set it in the textbox
    alternateAnswer3 = correctAnswer + math.random(7, 9)
...
local function TouchListenerAnswerbox(touch)
    ...
    if (alternateAnswerBox1AlreadyTouched == false) and (alternateAnswerBox3AlreadyTouched == false) and
